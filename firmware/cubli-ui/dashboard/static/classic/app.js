/* classic/app.js -- the ORIGINAL Tailwind dashboard's front end, kept as a
 * fallback and served at /classic. Preserved as-is; the default UI is now
 * ../app.js against ../index.html.
 *
 * It predates the runtime mode switch in
 * ../../../teensy/CubliBalance/CubliBalance.ino: the .mode-btn handlers below
 * send {type:"mode"}, which only overrides how app.py PARSES the stream. They
 * do not send m0/m1 and cannot change the cube's control law. Use the minimal
 * UI for that.
 *
