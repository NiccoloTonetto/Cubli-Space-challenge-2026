...
|---|---|---|
| [`CornerBalance/CornerBalance.ino`](../corner-bringup/Stage4_FullLaw/Stage4_FullLaw.ino) | `../../corner-bringup/Stage4_FullLaw/Stage4_FullLaw.ino` | 3 (ids 1/2/3) |
| [`EdgeBalance/EdgeBalance.ino`](../edge-bringup/Stage4_FullLaw/Stage4_FullLaw.ino) | `../../edge-bringup/Stage4_FullLaw/Stage4_FullLaw.ino` | 1 (X/Y/Z selectable) |
...
[`../plot_session_csv.py`](../cubli-ui/tools/analysis/plot_session_csv.py) — it reads both formats. It
looks for recordings under [`../telemetry/`](../../README.md), but a USB
