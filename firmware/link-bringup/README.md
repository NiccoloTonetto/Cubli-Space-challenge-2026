...
[`../link_check.py`](../cubli-ui/tools/link_check.py) walks the whole pipeline in one command.
...
[`../xiao_teensy_bridge/`](../cubli-ui/xiao/xiao_teensy_bridge/xiao_teensy_bridge.ino),
[`firmware/XIAO/xiao_teensy_bridge/`](../cubli-ui/xiao/xiao_teensy_bridge/xiao_teensy_bridge.ino)
...
[`../xiao_teensy_bridge/xiao_teensy_bridge.ino`](../cubli-ui/xiao/xiao_teensy_bridge/xiao_teensy_bridge.ino)
must agree on:
