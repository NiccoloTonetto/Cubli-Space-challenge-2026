...
Everything in [`firmware/panel-bringup/`](../firmware/panel-bringup) works end to end on hardware now — the
...
Companion to [`firmware/panel-bringup/Bring-Up-Stages-Implementation-Notes.md`](../firmware/panel-bringup/Bring-Up-Stages-Implementation-Notes.md),
...
The concrete stages (`firmware/panel-bringup/Stage0`…`Stage5`) are 2D-specific, but
...
- [`firmware/panel-bringup/README.md`](../firmware/panel-bringup/README.md) — the 2D firmware itself
- [`firmware/panel-bringup/Bring-Up-Stages-Implementation-Notes.md`](../firmware/panel-bringup/Bring-Up-Stages-Implementation-Notes.md) — full per-stage code walkthrough
- [`firmware/panel-bringup/Arduino-Bring-Up-Plan-Sections-2b-2d.md`](../firmware/panel-bringup/Arduino-Bring-Up-Plan-Sections-2b-2d.md) — the original procedure
