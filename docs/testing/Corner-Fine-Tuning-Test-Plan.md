...
[`../corner-bringup/`](../../firmware/archive/wifi-mode-prefinal/corner-bringup/README.md) and
[`../FINAL/`](../../README.md), same as everywhere else in this project:
...
| Fix | Where |
|---|---|
| 4.1 — first-order low-pass (15-25 Hz, 20 Hz default) on the rate signal feeding the control law's `om` block only (not `w_b` globally — trip checks and estimator stay on raw, unfiltered rate) | [`../corner-bringup/Stage4_AutoTrim_RateFilter/`](../../firmware/corner-bringup/Stage4_AutoTrim_RateFilter/Stage4_AutoTrim_RateFilter.ino), [`../corner-bringup/Stage5_AutoTrim_RateFilter/`](../../firmware/corner-bringup/Stage5_AutoTrim_RateFilter/Stage5_AutoTrim_RateFilter.ino) — live-settable with `f<Hz>` |
...
[`../../docs/dynamics/Cube-Performance-Envelope-Results.md`](../dynamics/Cube-Performance-Envelope-Results.md)'s
...
| Test(s) | File |
|---|---|
| 1 | [`../FINAL/fft_tilt_analysis.py`](../../firmware/cubli-ui/tools/analysis/fft_tilt_analysis.py) |
| 4 | [`../FINAL/standing_speed_report.py`](../../firmware/cubli-ui/tools/analysis/standing_speed_report.py) |
| 5, 6, 7 | [`../corner-bringup/Stage4_AutoTrim/`](../../firmware/corner-bringup/Stage4_AutoTrim/Stage4_AutoTrim.ino) (hand-held), [`../corner-bringup/Stage5_AutoTrim/`](../../firmware/corner-bringup/Stage5_AutoTrim/Stage5_AutoTrim.ino) (unsupported, real policy) |
| 5, 6, 7 + hw-run-analysis.md's 35 Hz fix | [`../corner-bringup/Stage4_AutoTrim_RateFilter/`](../../firmware/corner-bringup/Stage4_AutoTrim_RateFilter/Stage4_AutoTrim_RateFilter.ino), [`../corner-bringup/Stage5_AutoTrim_RateFilter/`](../../firmware/corner-bringup/Stage5_AutoTrim_RateFilter/Stage5_AutoTrim_RateFilter.ino) — same procedures as the plain AutoTrim files, plus `f<Hz>` for the rate-filter corner |
| 7 (plots) | [`../FINAL/plot_session_csv.py`](../../firmware/cubli-ui/tools/analysis/plot_session_csv.py) — recognizes all five corner telemetry widths now: 21 (`CornerBalance`/`CornerBalance_WiFi`), 26 (`Stage4_AutoTrim`), 29 (`Stage4_AutoTrim_RateFilter`), 33 (`Stage5_AutoTrim`, adds `trim`/`endurance` trace groups), 36 (`Stage5_AutoTrim_RateFilter`, adds filtered-rate traces to the `rates` group) |
...
- **Multi-corner locomotion is currently off the table on six of eight
  ...
  [`../../docs/dynamics/Cube-Performance-Envelope-Results.md`](../dynamics/Cube-Performance-Envelope-Results.md).
