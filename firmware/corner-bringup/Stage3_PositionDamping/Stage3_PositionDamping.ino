...
// Live phi offset (the "o" command family). ADDED to the raw measurement,
// same convention Stage 2 uses. Everything downstream of
// updateCornerProjection() -- control, arm gate, trips, telemetry -- sees the
// corrected value.
