...
# parents[] here counts from the FILE, so parents[1] == CubliUI/
# (replay.py -> dashboard -> CubliUI). Must match OUT_DIR in app.py.
OUT_DIR = Path(__file__).resolve().parents[1] / "telemetry" / "plot"
