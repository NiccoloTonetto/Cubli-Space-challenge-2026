...
| | USB | WiFi |
|---|---|---|
| **Corner** (3 wheels) | [`USBMODE/CornerBalance/`](../corner-bringup/Stage4_FullLaw/Stage4_FullLaw.ino) | [`WIFIMODE/CornerBalance_WiFi/`](wifi-mode-prefinal/CornerBalance_WiFi/CornerBalance_WiFi.ino) |
| **Edge** (1 axis) | [`USBMODE/EdgeBalance/`](../edge-bringup/Stage4_FullLaw/Stage4_FullLaw.ino) | [`WIFIMODE/EdgeBalance_WiFi/`](wifi-mode-prefinal/EdgeBalance_WiFi/EdgeBalance_WiFi.ino) |
...
[`telemetry/plot/`](../../README.md) — `telemetry_edge_<stamp>.csv` from
...
`telemetry/serial/`. See [`telemetry/README.md`](../../README.md) for what
separates the two.
...
[`WIFIMODE/corner-bringup/`](wifi-mode-prefinal/corner-bringup/README.md). Those are
read with [`WIFIMODE/terminal_wifi.py`](../cubli-ui/tools/terminal_wifi.py) — a
