...
// ============================================================================
// Companion to ../../xiao/console_host/console_host.ino and the web
...
// Serial1 <-> XIAO. MUST match TEENSY_LINK_BAUD in console_host.ino.
...
// ----------------------------------------------------------------------------
// Protocol, driven entirely by the XIAO (see console_host.ino):
//
